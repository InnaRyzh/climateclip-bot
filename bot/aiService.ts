            ...
            messages: [
              {
                role: 'system',
          content: [
            'Ты редактор новостной ленты. Перепиши исходный текст по-русски в 5 полных абзацев-хронологию по 20–25 слов (допустимо 18–26).',
            ...
            'Верни ТОЛЬКО JSON-массив из пяти строк вида ["...", "...", "...", "...", "..."] без пояснений и без форматирования Markdown.'
          ].join(' ')
              },
